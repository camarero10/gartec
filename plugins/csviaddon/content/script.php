...
class PlgcsviaddoncontentInstallerScript
{
	...
	public function postflight($parent)
	{
		...
		$folder = JPATH_ADMINISTRATOR . '/components/com_csvi/addon/com_content';

		if (JFolder::create($folder))
		{
			// Copy the folder to the correct location
			$src = JPATH_SITE . '/plugins/csviaddon/content/com_content';
	...
	{
		// Remove the files
		if (file_exists(JPATH_ADMINISTRATOR . '/components/com_csvi/addon/com_content'))
		{
			JFolder::delete(JPATH_ADMINISTRATOR . '/components/com_csvi/addon/com_content');
		}
	}
}
