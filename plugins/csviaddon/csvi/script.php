...
class PlgcsviaddoncsviInstallerScript
{
	...
	public function postflight($parent)
	{
		...
		$folder = JPATH_ADMINISTRATOR . '/components/com_csvi/addon/com_csvi';

		if (JFolder::create($folder))
		{
			// Copy the folder to the correct location
			$src = JPATH_SITE . '/plugins/csviaddon/csvi/com_csvi';
	...
	{
		// Remove the files
		if (file_exists(JPATH_ADMINISTRATOR . '/components/com_csvi/addon/com_csvi'))
		{
			JFolder::delete(JPATH_ADMINISTRATOR . '/components/com_csvi/addon/com_csvi');
		}
	}
}
