...
('expressproduct', 'expressproduct', 'com_virtuemart', 'import', '0'),
('expressproduct', 'virtuemart_products', 'com_virtuemart', 'import', '1'),
...
('orderadvanced', 'export', 'com_virtuemart', 'index.php?option=com_virtuemart&view=orders', 'source,orderadvanced_file,order,orderadvanced_layout,fields,limit.advancedUser'),
('snelstart', 'export', 'com_virtuemart', 'index.php?option=com_virtuemart&view=orders', 'source,snelstart_file,order,snelstart_layout,fields,limit.advancedUser'),
('yandex', 'export', 'com_virtuemart', 'index.php?option=com_virtuemart&view=orders', 'source,yandex_file,layout,fileproduct,fields,limit.advancedUser'),
...
('expressproduct', 'import', 'com_virtuemart', 'index.php?option=com_virtuemart&view=product', 'source,file,expressproduct,fields,limit.advancedUser'),
...
('waitinglist', 'export', 'com_virtuemart', NULL, 'source,file,layout,fields,limit.advancedUser'),
